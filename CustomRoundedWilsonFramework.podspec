Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomRoundedWilsonFramework"
  spec.version      = "0.0.1"
  ...
  spec.homepage     = "https://github.com/ThanatosFx/CustomRounded"
  ...
  spec.author             = { "dhanaryowilson" => "dhanaryowilson@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/ThanatosFx/CustomRounded.git", :tag => "#{spec.version}" }

	# Replace value of source file with your Path
  spec.source_files  = "CustomRoundedWilsonFramework/**/*.{swift}"
